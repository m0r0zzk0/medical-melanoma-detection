...
def main():
    ...
    BATCH_SIZE = 256
    LEARNING_RATE = 0.001
    NUM_EPOCHS = 3  # Начинаем с 3 для быстрого тестирования
    IMG_SIZE = 224
    ...
    # Заменяем последний слой (2048 → 2 классов)
    num_features = model.fc.in_features
    model.fc = nn.Linear(num_features, 1)  # Binary classification (1 output для sigmoid)
    ...
    # ============== LOSS & OPTIMIZER ==============
    # BCEWithLogitsLoss = Sigmoid + BCE (численно стабильнее)
